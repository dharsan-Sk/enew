                ...
                <Container className="px-lg-5 ">
                    ...
                    <div>
                        <Row>
                            ...
                            <p className="mt-5 p-lh ">As one of the best WordPress development company in Coimbatore, our services at Emergewiz
                            ...
                            <Col xs={12} md={6} className="mt-5">
                                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                                    <b className="cb">Custom Themes Development and Creation : </b>Our custom WordPress designs are created to completely capture the
                            ...
                            <Col xs={12} md={6} className="mt-5">
                                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                                  <b className="cb">Advanced Plugin Integration :
                            ...
                            <Col xs={12} md={6} className="mt-5">
                                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                                    <b className="cb">Responsive Web Design : </b>Every site we develop is mobile-friendly, ensuring it delivers a 
                            ...
                            <Col xs={12} md={6} className="mt-5">
                                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                                    <b className="cb">E-Commerce Solutions : </b>It involves creating secure and reliable e-shops on the WordPress platform,
                            ...
                            <Col xs={12} md={6} className="mt-5">
                                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                                    <b className="cb">Content Management and Optimization : </b>How do we make it easy for you to manage your site’s content?
                            ...
                            <Col xs={12} md={6} className="mt-5">
                                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                                    <b className="cb">Support and Maintenance : </b>Creating a website is one thing though starting it up is different.
                                     Here at Emergewiz- a WordPress development company in Coimbatore, we assist you in managing your website
                                      by updating, protecting, and optimizing it in every manner possible. A dedicated team of support is available 
                                      at all times to help with any problems or changes so that users can concentrate on their core business.
                                </p>
                            </Col>
                        </Row>
                    </div>
