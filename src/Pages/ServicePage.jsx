        ...
        <Container className="px-lg-5 ">
          <div className="S-section-title position-relative text-center mb-3 pb-2 wow fadeInUp">
            ...
            <Row>
              <Col xs={12} md={6} className="mt-5">
                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                  <b className="cb">Requirement Analysis : </b>We begin the process by considering the goals of the project, as informed by the client.
                  It also helps us provide you with a detailed and comprehensive strategy for testing and development.
                </p>
              </Col>
              <Col xs={12} md={6} className="mt-5">
                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                  <b className="cb">Test Planning : </b> It also helps in constructing a test plan that covers the aspects of testing scope,
            ...
            <Row>
              <Col xs={12} md={6} className="mt-5">
                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                  <b className="cb">Test Design : </b> Our team creates clear test cases and scripts according to the specific characteristics of your software.
                  This step involves the definition of test scenarios and test data preparation.
                </p>
              </Col>
              <Col xs={12} md={6} className="mt-5">
                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                  <b className="cb">Test Execution : </b>
            ...
            <Row className="mb-5">
              <Col xs={12} md={6} className="mt-5">
                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                  <b className="cb">Defect Management : </b>  We analyze and prioritize the defects identified, collaborating with your development team to ensure timely resolution and retesting of fixed issues.

                </p>
              </Col>
              <Col xs={12} md={6} className="mt-5">
                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                  <b className="cb">Test Reporting :  </b>
