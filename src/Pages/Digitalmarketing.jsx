                    ...
                    <div>
                        <Row>
                            ...
                            <Col
                                ...
                                lg={6} className="mt-5 ">
                                <div>
                                    <p className="text-start mt-3 p-lh ">Emergewiz has realized how quickly the environment changes
                                    ...
                                    <p className="text-start p-lh ">While many may think that digital marketing is all about just exposing people to your website,
                        ...
                        <Row>
                            ...
                            <Col xs={12} md={6} className="mt-5">
                                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                                    <b className="cb">Search Engine Optimization (SEO) : </b> Our SEO packages will help boost your website ranking and make
                            ...
                            <Col xs={12} md={6} className="mt-5">
                                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                                    <b className="cb">Pay-Per-Click (PPC) Advertising :
                            ...
                            <Col xs={12} md={6} className="mt-5">
                                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                                    <b className="cb">Social Media Marketing : </b>Establish yourself or your business with our expert social
                            ...
                            <Col xs={12} md={6} className="mt-5">
                                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                                    <b className="cb">Content Marketing : </b>Create engaging and high-value content in a way to convince the audience.
                            ...
                            <Col xs={12} md={6} className="mt-5">
                                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                                    <b className="cb">Email Marketing : </b>Enhance customer interactions by using email marketing messages for closely
                            ...
                            <Col xs={12} md={6} className="mt-5">
                                <p className="mycard mx-3 lh-base text-start mt-3 h-100" >
                                    <b className="cb">WhatsApp Marketing : </b>Over the years WhatsApp has proved to be an effective communication tool,
                            ...
                            <p className="text-center mt-3">
                                <button className="br20px p-3 mt-5">Choose our Digital Marketing Company in Coimbatore to take your business to the next level and get outstanding
                        ...
                        <Row>
                            <Col  sm={12}
                                ...
                                <Col className=""><div className="p-3">
                                    <h4 className="cb mb-3 ">Research and Strategy Development</h4>
                                    <p className="p-lh ">We start by understanding the business and audience as well as the business and industry on which you will be operating. It helps to develop an individualized working approach to the digital marketing strategy that corresponds to your objectives.
                                    </p></div></Col>
                                <Col className="">  <div className="p-3">
                                    <h4 className="cb mt-3 mb-3">Execution and Optimization</h4>
                                    <p className="p-lh "> Here our team of professionals put it into practice using any best practices and tools. Campaigns are constantly being tripped and adjusted to keep them fresh and make them get the most bang for the buck.</p>
                                </div></Col>
                                <Col className=""> <div className="p-3">
                                    <h4 className="cb mt-3 mb-3">Analysis and Reporting</h4>
                                    <p className="p-lh ">KPIs are provided in the form of daily, weekly, monthly, annually and our unique analytical approach is applied to assess the effectiveness of planning in achieving stated goals and objectives.
                                    </p>
                                </div></Col>
                            </Col>
                            <Col  sm={12}
