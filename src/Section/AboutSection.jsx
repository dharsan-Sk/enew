      ...
      <Container className='px-lg-5 ' >
        <div className='S-section-title position-relative text-center mb-3 pb-2 wow fadeInUp'>
          ...
          <p className='m-5 p-lh'>
            Emergewiz specializes in creating innovative and customized digital solutions tailored to meet the unique needs of
             each business. Their comprehensive range of services includes web design, web development, SEO, social media marketing,
              and PPC advertising. With a team of skilled professionals and a client-centric approach, Emergewiz ensures that every 
              project not only meets but exceeds client expectations, driving growth and success in the digital landscape.
          </p>
        </div>
