...
function HeroSection(props) {
  const mydata = useMemo(() => [
    ...
    {
      title:"Products",
      header:"Discover Our Premium Products SmartStorez & FoodDuke!",
      para:"Browse a wide range of products designed to drive business success. From innovative solutions like SmartStorez and FoodDuke, we offer something for every business. Explore now and find the perfect products to elevate your success.",
    },
    {
      title:"Career",
      header:"Join Our Team at Emergewiz and Make an Impact!",
      para:"Whether you're just starting your career or are an experienced professional, there's a place for you here. Explore our open positions and discover how you can contribute to a team that values diversity, creativity, and excellence.",
    },
    {
      title:"Contact",
      header:"Let’s Connect – We’re Here for You!",
      para:"Have a question, feedback, or need assistance? Our team is here to help. Whether you’re interested in our services, need support, or simply want to get in touch, we’re just a message away.",
    },
